...
if __name__ == '__main__':
    ...
    for i in range(0,len(grid)):
        for j in range(0,len(grid[0])-3):
            ...
            if product > max_product:
                ...
                [max_product, max_i, max_j] = [product, i, j]
    ...
    # scanning diagonally down-and-right
    for i in range(0,len(grid)-3):
        for j in range(0,len(grid[0])-3):
            product = 1
            for k in range(0,4):
    ...
    # scanning diagonally down-and-left
    for i in range(0,len(grid)-3):
    ...
    print "Greatest product: ", max_product
